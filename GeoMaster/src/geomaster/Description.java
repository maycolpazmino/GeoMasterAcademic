...
public class Description extends javax.swing.JFrame {
    ...
    public Description() {
        ...
        cobLitology.addItem("Sandstoneeeeeeeeeeeeeeee");
    ...
    private void initComponents() {
        ...
        cromatografia.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        cromatografia.add(fotoCromatografia, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        jScrollPane5.setBorder(null);

        GasesLog.setBorder(null);
        ...
        cromatografia.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 150, 170, 90));
